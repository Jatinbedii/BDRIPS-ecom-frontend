        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
              ...
              <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                      <h2 class="mb-6 text-sm font-semibold text-white uppercase ">HELPLINE</h2>
                      <ul class="text-white font-medium">
                          <li class="mb-4">
                              <div class="hover:underline">Contact Us</div>
                          </li>
                          <li>
                              <div class="hover:underline">Customer Care</div>
                          </li>
                      </ul>
                  </div>
                  <div>
                      ...
                      <ul class="text-white font-medium">
                          <li class="mb-4">
                              <div  class="hover:underline ">YouTube</div>
                          </li>
                          <li>
                              <div class="hover:underline">LinkTree</div>
                          </li>
                      </ul>
                  </div>
                  <div>
          ...
          <div class="sm:flex sm:items-center sm:justify-between">
              <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"> <a class="hover:underline">Project by</a> Jatin Bedi
              </span>
